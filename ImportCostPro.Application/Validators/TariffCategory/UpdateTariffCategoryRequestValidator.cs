...
{
    public class UpdateTariffCategoryRequestValidator : AbstractValidator<UpdateTariffCategoryRequest>
    {
        public UpdateTariffCategoryRequestValidator()
        {
            RuleFor(x => x.Id)
                .GreaterThan(0).WithMessage("El ID de la categoría arancelaria no es válido.");
