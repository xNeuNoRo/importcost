    ...
    public class CountryController : Controller
    {
        ...
        public async Task<IActionResult> Create(CountryCreateViewModel viewModel)
        {
            ...
            try
            {
                ...
                TempData["SuccessMessage"] = "País creado exitosamente.";
            ...
            {
                ModelState.AddModelError(string.Empty, "Ocurrió un error inesperado al crear el país.");
            }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            var viewModel = country.Adapt<CountryViewModel>();
            return View(viewModel);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                TempData["ErrorMessage"] = "Ocurrió un error inesperado al eliminar el país.";
            }
