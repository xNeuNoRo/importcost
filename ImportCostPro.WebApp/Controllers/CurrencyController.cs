    ...
    public class CurrencyController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateCurrencyViewModel viewModel)
        {
            ...
            try
            {
                ...
                TempData["SuccessMessage"] = "Moneda registrada correctamente.";
        ...
        public async Task<IActionResult> Edit(UpdateCurrencyViewModel viewModel)
        {
            ...
            try
            {
                ...
                TempData["SuccessMessage"] = "Moneda actualizada correctamente.";
                return RedirectToAction(nameof(Index));
            }
            catch (ValidationBusinessException ex)
            {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                TempData["SuccessMessage"] = "Moneda eliminada con éxito.";
            }
            catch (BusinessException ex)
            {
            ...
            {
                TempData["ErrorMessage"] = "Ocurrió un error inesperado al intentar eliminar la moneda.";
            }
        ...
        public async Task<IActionResult> ToggleStatus(int id)
        {
            try
            {
                ...
                TempData["SuccessMessage"] = "Estado de la moneda actualizado correctamente.";
            }
            catch (BusinessException ex)
            {
                TempData["ErrorMessage"] = ex.Message;
